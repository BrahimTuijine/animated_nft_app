...
import 'package:animated_nft_app/core/animation/route_transition.dart';
import 'package:animated_nft_app/core/constants/constants.dart';
import 'package:animated_nft_app/screens/nft_screen.dart';
...
class CustomListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(FadeTransitonAnimation(
            page: NFTScreen(
